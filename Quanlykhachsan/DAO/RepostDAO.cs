...
namespace DAO
{
    public class RepostDAO
    {
        ...
        public static List<SalesRepostDTO> TinhTongDoanhThuTheoLoaiPhong()
        {
        ...
        public static List<SalesRepostDTO> DoanhThuTheoLoaiPhongTheoThang(DateTime ntm_min, DateTime ntm_max)
        {
            var query = from p in context.PHONGs
