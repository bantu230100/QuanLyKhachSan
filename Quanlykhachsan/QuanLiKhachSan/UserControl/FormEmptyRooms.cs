...
{
    public partial class FormEmptyRooms : DevExpress.XtraEditors.XtraUserControl
    {

        List<RoomDTO> lstPhong = new List<RoomDTO>();
        public FormEmptyRooms()
        {
            InitializeComponent();
            if (txtMaPhong.Text == "")
        ...
        {
            List<RoomDTO> danhmuclst = new List<RoomDTO>();
