...
{
    public partial class FormServiceManagetment : DevExpress.XtraEditors.XtraUserControl
    {
        public FormServiceManagetment()
        {
            InitializeComponent();
        }
        ...
        {
            UserControl.formOderService oder = new formOderService();
            oder.ShowDialog();
        }
        ...
        {
            List<ServiceDTO> lstt = new List<ServiceDTO>();
        ...
        private ServiceDTO LayThongTinDichVu()
        {
            ServiceDTO infor = new ServiceDTO();
