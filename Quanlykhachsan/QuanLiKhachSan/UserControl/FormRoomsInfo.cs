...
{
    public partial class FormRoomsInfo : DevExpress.XtraEditors.XtraUserControl
    {
        public FormRoomsInfo()
        {
            InitializeComponent();
        ...
        private RoomDTO LayThongTinPhong()
        {
            RoomDTO infor = new RoomDTO();
            if (txtMaPhong.Text != "")
            {
        ...
        {
            List<RoomDTO>  ldg = RoomBUS.LoadDonGia("A");
            List<RoomDTO> ldg1 = RoomBUS.LoadDonGia("B");
            List<RoomDTO> ldg2 = RoomBUS.LoadDonGia("C");
